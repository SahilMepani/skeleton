<?php if ( get_row_layout() == 'fixed_and_fluid_column_3' ) : ?>
...
<section class="fixed-and-fluid-column-3 <?php echo $section_padding_top . ' ' . $section_padding_bottom ?> <?php echo $section_classes . ' ' . $section_bg_color; ?>" style="<?php echo $section_css ?>">
