<?php if ( get_row_layout() == 'images_slider_section' ) : ?>
	...
	<section class="images-slider-section clear <?php echo $section_classes ?>" style="<?php echo $section_css ?>">
		...
		<div class="swiper-container images-slider">
			...
			<div class="container">
				<div class="swiper-pagination swiper-dot-pagination"></div> <!-- .swiper-dot-pagination -->
			</div> <!-- .container -->

		</div> <!-- .swiper-container.images-slider -->

	</section> <!-- .images-slider-section -->
<?php endif; ?>