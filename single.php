							...
							<div class="author-info">
								...
								<ul class="list-author-meta list-connections list-unstyled">
									<?php
											...
											if ( $url ) {
											?>
									<li class="i-info"><a href="<?php echo $url; ?>" title="Visit my website">Website</a>
									</li>
									<?php }?>
<?php
		...
		if ( $twitter ) {
		?>
									<li class="i-twitter"><a href="https://twitter.com/<?php echo $twitter; ?>"
											title="Follow me on twitter">Twitter</a></li>
									<?php }?>
<?php
		$facebook = get_the_author_meta( 'facebook' );
		if ( $facebook ) {
		?>
									<li class="i-facebook"><a href="<?php echo $facebook; ?>"
											title="View my facebook profile">Facebook</a></li>
									<?php }?>
<?php
		$google = get_the_author_meta( 'googleplus' );
		if ( $google ) {
		?>
									<li class="i-gplus"><a href="https://googleplus.com/<?php echo $google; ?>"
						...
						<div class="post-nav clearfix">
							...
							<div class="old-post">
								<a href="<?php echo $prev_post->guid ?>"
									title="<?php echo $prev_post->post_title; ?>"><?php echo $prev_post->post_title ?></a>
							</div>
							<?php }?>

							<div class="text-center"><a
									href="<?php echo get_permalink( get_option( 'page_for_posts' ) ) ?>">Blog Home</a></div>
