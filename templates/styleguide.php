	...
	<div class="container py-4">
		...
		<div class="row row-cols-2 gx-5 mb-10">
			<div class="col">
				...
				<div class="h1 mb-4">This is a heading and it needs to span two lines to get an idea about line-height
					too</div>
				...
				<p>There should be two paragraph stacked on top of each other to get an idea about the spacing required
					between them.</p>
				<p class="mb-6">You might have noticed all the monospaced text in this guide. There are a number of
					inline <abbr title="HyperText Markup Language">HTML</abbr> elements you may use anywhere within
					other elements, including <abbr title="Abbreviation">abbr</abbr>, <cite>cite</cite>,
					<code>code</code>, <del>del</del>, <em>em</em>, <ins>ins</ins>, <strong>strong</strong>,
					<var>var</var>, and <a href="#" title="link">link</a></p>
			...
			<div class="col">
				...
				<hr class="mb-4">
				<div class="d-block text-gray-500 fw-bold mb-1">H1</div>
				<div class="h2 mb-4">This is a heading and it needs to span two lines to get an idea about line-height
					too</div>
				<div class="d-block text-gray-500 fw-bold mb-1">H2</div>
