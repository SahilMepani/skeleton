<?php
/**
 * Popular Course Slider ACF Block
 *
 * @package Skeleton
 * @subpackage ACF
 */
...
<section
	class="popular-course-slider-section section <?php echo esc_attr( "section-display-{$display} {$spacing_top} {$spacing_bottom} {$custom_classes}" ); ?>"
