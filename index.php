				...
				<form action="<?php echo home_url(); ?>/" method="get" id="ajax-search-post" data-cpt="post" data-tax="category">
					...
					<div id="ajax-submit-block" class="submit-block">
						<div class="search-icon-block">
							<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 18 18"><path fill="#B2993E" d="M11.417 10.042L16 14.625 14.625 16l-4.542-4.583v-.708l-.292-.25c-1.111.944-2.403 1.417-3.875 1.417-1.639 0-3.035-.576-4.188-1.729S-.001 7.598-.001 5.959c0-1.639.576-3.042 1.729-4.208S4.263.001 5.874.001c1.639 0 3.035.583 4.187 1.75S11.79 4.32 11.79 5.959c0 1.472-.472 2.764-1.417 3.875l.292.208h.75zm-5.5 0c1.139 0 2.111-.396 2.917-1.188s1.208-1.757 1.208-2.896-.403-2.111-1.208-2.917-1.778-1.208-2.917-1.208c-1.139 0-2.104.403-2.896 1.208S1.833 4.819 1.833 5.958c0 1.139.396 2.104 1.188 2.896s1.757 1.188 2.896 1.188z"/></svg>
					...
					<a href="#" id="ajax-search-clear" class="clear-search" title="clear">
						<div class="clear-icon-block">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 18 18"><path fill="#B2993E" d="M3.727 2.727l10.09 10.09-1.164 1.164-10.09-10.09 1.164-1.164z"/><path fill="#B2993E" d="M13.817 3.891l-10.09 10.09-1.164-1.164 10.09-10.09 1.164 1.164z"/></svg>
						</div> <!-- .clear-svg-block -->
					</a>
				</form>
