...
/**
 * Retrieves the content of an SVG file located in the current active theme '/images/svg/' directory
 *
...
/**
 * Overrides the default behavior of image URLs.
 *
 * With this change, when inserting images into posts or pages,
 * they will default to having no link associated with them.
 */
