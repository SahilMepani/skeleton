				...
				foreach ( $swp_query->posts as $post ) :
					...
					<li class="card">
						<div class="img-cover-block">
							...
							?>
							<img src="<?php echo wp_get_attachment_image_url( $image_ID, 'w768' ); ?>" srcset="<?php echo wp_get_attachment_image_srcset( $image_ID ); ?>" sizes="45rem" alt="<?php echo $image_alt; ?>" width="<?php echo $image_data[1]; ?>" height="<?php echo $image_data[2]; ?>" class="img-cover" loading="lazy" />
						</div>
