  ...
  <div class="project-filters-block margin-bottom-3">
    ...
    <div class="custom-select-block hidden-sm hidden-md hidden-lg">
      ...
      <select id="ajax-first-select-post-categories">
        <option data-cpt="project" data-first-cpt-tax="tax-one" data-first-cat-id="-1"><?php _e('All Tax One','skel'); ?></option>
        <?php
          $cats_args = array(
            'taxonomy' => 'tax-one',
          );
    ...
    <div class="custom-select-block hidden-sm hidden-md hidden-lg">
      <label for="ajax-second-select-post-categories" class="sr-only"><?php _e('Select Tax Two','skel'); ?></label>
      <select id="ajax-second-select-post-categories">
        <option data-cpt="project" data-second-cpt-tax="tax-two" data-second-cat-id="-1"><?php _e('All Tax Two','skel'); ?></option>
        <?php
          $cats_args = array(
            'taxonomy' => 'tax-two',
          );
    ...
    <ul id="ajax-first-list-post-categories" class="list-tax-one-filters list-filters hidden-xs">
      <li class="js-active">
        <a href="javascript:void(0);" data-cpt="project" data-first-cpt-tax="tax-one" data-first-cat-id="-1"><?php _e('ALL','skel'); ?></a>
      </li>
      <?php
        $cats_args = array(
          'taxonomy' => 'tax-one',
    ...
    <ul id="ajax-second-list-post-categories" class="list-tax-two-filters list-filters hidden-xs">
      <li class="js-active">
        <a href="javascript:void(0);" data-cpt="project" data-second-cpt-tax="tax-two" data-second-cat-id="-1"><?php _e('ALL','skel'); ?></a>
      </li>
      <?php
        $cats_args = array(
          'taxonomy' => 'tax-two',
