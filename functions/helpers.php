	...
	if ( 1 < $total_pages ) {
		...
		echo paginate_links(
			array(
				...
				'total'      => $total_pages,
				'prev_text'  => svg( 'arrow-left', array( 'aria-hidden' => 'true' ) ) . '<span class="screen-reader-text">' . esc_html__( 'Previous page', 'skel' ) . '</span>',
				'next_text'  => svg( 'arrow-right', array( 'aria-hidden' => 'true' ) ) . '<span class="screen-reader-text">' . esc_html__( 'Next page', 'skel' ) . '</span>',
				'mid_size'   => 1,
				'start_size' => 0,
				'end_size'   => 0,
			)
