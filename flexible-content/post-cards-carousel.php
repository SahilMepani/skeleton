<?php if ( get_row_layout() == 'post_cards_carousel' ) : ?>
...
<section class="post-cards-carousel-section position-relative <?php echo $section_padding_top . ' ' . $section_padding_bottom ?> <?php echo $section_classes . ' ' . $section_bg_color; ?>" style="<?php echo $section_css ?>">
	<div class="container">

		<?php if ( $posts ) : ?>

			<div class="list-post-cards post-cards-carousel">
