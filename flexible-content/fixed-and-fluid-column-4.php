<?php if ( get_row_layout() == 'fixed_and_fluid_column_4' ) : ?>
...
<section class="fixed-and-fluid-column-4 <?php echo $section_padding_top . ' ' . $section_padding_bottom ?> <?php echo $section_classes . ' ' . $section_bg_color; ?>" style="<?php echo $section_css ?>">
	...
	<div class="flex">
		...
		<div class="fluid-col">
			<img src="<?php echo $fluid_column['sizes']['w1250']; ?>" alt="" />
		</div> <!-- .fluid-col -->
