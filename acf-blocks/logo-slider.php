...
<section
	...
	<div class="container">
		...
		<div class="<?php echo skel_swiper_direction_class(); //phpcs:ignore ?> logo-slider" data-inview
			data-aos="fade">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide slide">
					<div class="logo-block">
						...
						?>
						<img src="<?php echo esc_attr( wp_get_attachment_image_url( $logo, 'w768' ) ); ?>"
							srcset="<?php echo esc_attr( wp_get_attachment_image_srcset( $logo ) ); ?>" sizes="40rem"
