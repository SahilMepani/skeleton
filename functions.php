...
function tse_scripts() {
	...
	wp_enqueue_script('jquery-plugins', get_template_directory_uri() . '/js/plugins.js', array('jquery'), '1.0', true);
	wp_enqueue_script('jquery-custom', get_template_directory_uri() . '/js/custom.js', array('jquery', 'plugins'), '1.0', true);
	wp_enqueue_script('jquery-admin-ajax', get_template_directory_uri() . '/js/admin-ajax.js', array('jquery'), '1.0', true);
	/* First argument is the handle where it is used */
	wp_localize_script('jquery-admin-ajax', 'localize_var', array(
