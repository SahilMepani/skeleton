				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="img-cover-block">
							<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/placeholder/1.jpg" class="img-cover" alt="">
						</div> <!-- .img-cover-block -->
					</div> <!-- .swiper-slide -->

					<div class="swiper-slide">
						<div class="img-cover-block">
							<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/placeholder/2.jpg" class="img-cover" alt="">
						</div> <!-- .img-cover-block -->
					</div> <!-- .swiper-slide -->
				</div> <!-- .swiper-wrapper -->
			</div> <!-- .swiper -->
