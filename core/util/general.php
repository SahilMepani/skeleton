...
/**
 * Builds the URL for the specified local image.
 *
 * @since 1.0.0
 *
 * @param string $path The relative path to the local image.
 * @return string
 */
function core_local_img( $path ) {
	return TPL_URL."/packages/assets/images/{$path}";
}
