...
<body <?php body_class( 'site-wrapper' );?>>
	...
	<header class="site-header clearfix" role="banner">
		<div class="container-fluid">
			...
			<button class="header-nav-toggle btn" aria-label="<?php _e( 'show primary navigation', 'skel' );?>"
				aria-haspopup="true" aria-expanded="false" aria-controls="siteMenu"><i
					class="i-font-before i-menu"></i><?php _e( 'Menu', 'skel' );?></button>

			<nav class="header-nav" role="navigation" aria-label="<?php _e( 'primary navigation', 'skel' );?>">
				<button class="header-nav-close" aria-label="<?php _e( 'close primary navigation' );?>"
					aria-haspopup="true" aria-expanded="true" aria-controls="siteMenu"><i
						class="i-font-before i-x"></i></button>
				<?php wp_nav_menu( [
